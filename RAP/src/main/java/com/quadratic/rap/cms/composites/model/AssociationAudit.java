...
public class AssociationAudit
{
    ...
    private DisclosureAssociation disclosureAssociation;
    ...
    /**
     * @return the DisclosureAssociation
     */
    public DisclosureAssociation getDisclosureAssociation()
    {
        return disclosureAssociation;
    }

    /**
     * @param firm the firm to set
     */
    public void setDisclosureAssociation( DisclosureAssociation disclosureAssociation )
    {
        this.disclosureAssociation = disclosureAssociation;
    }
